                            ...
                            <div className="col-md-12">
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <br />
                                        <h4 className="d-flex justify-content-center">{coronaIndonesia.positif}</h4>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="d-flex justify-content-center">
                                        ...
                                        <br />
                                        <h4 className="d-flex justify-content-center">{coronaIndonesia.sembuh}</h4>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-12">
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <br />
                                        <h4 className="d-flex justify-content-center">{coronaIndonesia.meninggal}</h4>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="d-flex justify-content-center">
                                        ...
                                        <br />
                                        <h4 className="d-flex justify-content-center">{coronaIndonesia.dirawat}</h4>
                                    </div>
                                </div>
                            </div>
                        </Card.Title>
                    ...
                    <Card.Body>
                        <Card.Title>
                            <div className="col-md-12">
                                ...
                                <br />
                                <h4 className="d-flex justify-content-center">{globalPositive}</h4>
                            </div>
                            <div className="col-md-12">
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <br />
                                        <h4 className="d-flex justify-content-center">{globalDeath}</h4>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="d-flex justify-content-center">
                                        ...
                                        <br />
                                        <h4 className="d-flex justify-content-center">{globalRecover}</h4>
                                    </div>
                                </div>
                            </div>
                        </Card.Title>
